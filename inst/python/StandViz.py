...
class StandViz:
    ...
    def Viz_StandObject( self, FileName ):
        ...
        OUT.write( "-P1 -N 0 -H 0.33 -T{}\\FIA.trf {} {}".format(self.SvsPath,OutFilename,SvsFilename) )
        OUT.close()
    ...
    def Viz_TBL2SVSObject( self, FileName ):
        ...
        OUT.close()
        OUT = open( OptFilename, 'w')
        if( self.TreeForm=='NRCS' ): OUT.write( "-P1 -N 0 -H 0.33 -T{}\\NRCS.trf {} {}".format(self.SvsPath,OutFilename,SvsFilename) )
        else: OUT.write( "-P1 -N 0 -H 0.33 -T{}\\FIA.trf {} {}".format(self.SvsPath,OutFilename,SvsFilename) )
        OUT.close()
        if( not os.path.exists( self.SvsExe ) ): print( "This command will fail!: {}".format(self.SvsExe))
        cmdline = "{} -G -X{} {}".format(self.SvsExe,OptFilename,SvsFilename)
        print( "cmdline={}".format(cmdline) )
